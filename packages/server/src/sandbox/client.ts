 ...
 *
 * Provides methods to interact with Modal sandboxes from the server.
...
export interface CreateSandboxRequest {
  sessionId: string;
  sandboxId?: string; // Expected sandbox ID (generated by server)
  repoOwner: string;
  repoName: string;
  serverUrl: string;
    ...
    try {
      ...
      const response = await fetch(this.createSandboxUrl, {
        ...
        body: JSON.stringify({
          ...
          sandbox_id: request.sandboxId || null, // Use server-generated ID
